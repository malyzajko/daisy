...
object ApproxBenchmarksLarge {
  ...
  } ensuring (res => res +/- 2.15e-02) // for Fixed32 Abs error: 0.00021461025199390595 Real range: [0.2514148950272635, 0.8787756292228485]
}
