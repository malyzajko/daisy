...
require(image >= -153.55 && image <= 291.35 && image.size(81,81)
	 && image.specM(Set((Set((79, 24), (61, 52), (15, 30), (53, 69), (54, 13), (33, 45), (78, 77), (28, 3), (29, 32), (54, 40), (6, 48), (12, 43), (37, 42), (52, 24), (13, 8), (13, 17), (23, 61), (67, 61), (69, 58), (53, 7)),(-6.5, 223.22)), (Set((59, 2), (34, 12), (11, 44), (63, 27), (46, 41), (47, 73), (30, 57), (74, 2)),(-17.21, 174.38)),
		...
		(Set((38, 23), (78, 4), (50, 61), (59, 18)),(31.71, 95.72)), (Set((19, 9), (40, 50), (51, 80), (13, 26), (75, 1), (25, 61), (63, 45)),(-84.79, 15.12)),
		(Set((57, 59), (75, 10), (72, 50)),(-58.74, 278.8)), (Set((33, 13)),(-124.84, 5.55)),
		(Set((26, 7)),(-125.59, 153.78)), (Set((35, 19), (39, 10), (55, 6), (70, 59), (74, 4)),(-123.41, 192.49)),
		(Set((76, 10), (72, 43), (21, 41), (41, 74)),(271.17, 277.96)), (Set((15, 64), (16, 63), (43, 34), (56, 62), (11, 39)),(28.99, 58.88)),
		(Set((55, 29), (21, 52), (50, 51), (62, 16)),(5.66, 227.23)), (Set((34, 9), (3, 58), (69, 3), (48, 35), (75, 53), (41, 5), (18, 46)),(63.04, 251.14)),
		(Set((24, 62)),(-61.35, 24.75)), (Set((51, 79), (73, 0), (24, 80), (24, 25), (46, 22), (76, 35), (31, 67)),(214.99, 289.52)),
		(Set((56, 66), (0, 34), (45, 11), (68, 40), (21, 20), (60, 2)),(-89.75, -38.84)), (Set((70, 13), (42, 15), (40, 11)),(-129.79, 143.24)),
		(Set((0, 27), (76, 37), (79, 48), (44, 5), (53, 38)),(26.57, 70.03)), (Set((47, 40), (19, 42), (39, 75), (56, 6), (12, 67), (74, 60), (6, 35)),(-85.35, 234.39))))
