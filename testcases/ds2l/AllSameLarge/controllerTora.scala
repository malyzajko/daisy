...
require(10.197819 <= bias4 && bias4 <= 10.197819
	 && x >= -2.0 && x <= 2.0 && x.size(500)
	 && bias1 >= 0.040232 && bias1 <= 0.341392 && bias1.size(500)
	 && bias2 >= 0.082624 && bias2 <= 0.318763 && bias2.size(500)
	 && bias3 >= 0.096189 && bias3 <= 0.297542 && bias3.size(500)
	 && weights1 >= -0.374036 && weights1 <= 0.319683 && weights1.size(500,500)
	 && weights2 >= -0.426394 && weights2 <= 0.323056 && weights2.size(500,500)
	 && weights3 >= -0.582338 && weights3 <= 0.566423 && weights3.size(500,500)
