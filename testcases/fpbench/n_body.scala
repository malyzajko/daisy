...
object n_body {
  ...
  def n_body(x0: Real, y0: Real, z0: Real, vx0: Real, vy0: Real, vz0: Real): Real = {
    require(((-6.0 < x0) && (x0 < 6.0) && (-6.0 < y0) && (y0 < 6.0) && (-0.2 < z0) && (z0 < 0.2) && (-3.0 < vx0) && (vx0 < 3.0) && (-3.0 < vy0) && (vy0 < 3.0) && (-0.1 < vz0) && (vz0 < 0.1)))
    val dt: Real = 0.1
