...
import Real._
@strictfp
object test04_dqmom9_order {


  def test04_dqmom9_order(m0: Real, m1: Real, m2: Real, w0: Real, w1: Real, w2: Real, a0: Real, a1: Real, a2: Real): Real = {
    ...
    _ret5
  } ensuring((res) => (res +/- 0.1665433081204269))
