...
import Real._
@strictfp
object hartman6_order {


  def hartman6_order(x1: Real, x2: Real, x3: Real, x4: Real, x5: Real, x6: Real): Real = {
    ...
    val _ret7: Real = -(((((1.0 * exp1) + (1.2 * exp2)) + (3.0 * exp3)) + (3.2 * exp4)))
    _ret7
  } ensuring((res) => (res +/- 1.389738347539253e-13))
