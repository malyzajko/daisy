...
import Real._
@strictfp
object instantaneousCurrent_64 {


  def instantaneousCurrent_64(t: Real, resistance: Real, frequency: Real, inductance: Real, maxVoltage: Real): Real = {
    ...
    _ret4
  } ensuring((res) => (res +/- 0.014305808360917053))
